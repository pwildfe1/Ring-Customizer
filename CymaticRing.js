let CymaticRing = function(parent, frequency, threshold){
...
CymaticRing.prototype.createUI = function(){
...
CymaticRing.prototype.update = function (){
    ...
    $.ajax({
        ...
        url: view.app.master_IP + '/cymatic',
        success: (response)=> {
